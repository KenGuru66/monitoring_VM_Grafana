...
- [Быстрый старт](#быстрый-старт)
  ...
  - [perf_zip2csv - CSV генератор](#perf_zip2csv---csv-генератор-)
- [Установка](#установка)
...
### perf_zip2csv - CSV генератор 📊

Новый утилитный скрипт для генерации отдельных CSV файлов по типам ресурсов **БЕЗ** отправки в VictoriaMetrics:

```bash
# Базовое использование
python3 perf_zip2csv.py Storage_History_Performance_Files.zip -o output_csvs/

# С большим количеством workers
python3 perf_zip2csv.py archive.zip -o csvs/ --workers 8

# С подробным логированием
python3 perf_zip2csv.py archive.zip -o csvs/ --verbose
```
...
**Использование:**
- Анализ данных в Excel/Pandas
- Интеграция с другими системами
- Валидация данных перед импортом в TSDB
- Архивирование в человекочитаемом формате
